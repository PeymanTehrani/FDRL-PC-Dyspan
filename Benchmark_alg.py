...
class Benchmark_alg():
    ...
    def time_cost(self, H2):
        ...
        time_cost_p_max = time.time() - st
        st = time.time()
        p_random = self.random_power()
        time_cost_random = time.time() - st
        return [time_cost_fp, time_cost_wmmse,time_cost_p_max,time_cost_random], [p_fp, p_wmmse, p_max, p_random]
