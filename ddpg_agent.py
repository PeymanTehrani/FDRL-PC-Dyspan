...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 12 13:53:57 2021
...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, n_actions, gamma=0,
    ...
    def choose_action(self, observation,k):
        ...
        # noise=np.random.uniform(- (1/k)**(.3), (1/k)**(.3), mu.shape)
    ...
    def learn(self):
        ...
        return critic_loss.item(),actor_loss.item(),target.detach().numpy(),critic_value.detach().numpy()
